...
const BikeParkCreatedDalog: React.FC<BikeParkCreatedDalogProps> = ({ data, onClose }) => {
  return (
    <ModalDialog
      isOpen={!!data.name}
      onClose={onClose}
      title="Bike park has been created"
    >
      <div>
        ...
        <h3 className="text-lg font-medium text-gray-900 mb-2 text-center">Bike Park Created Successfully!</h3>
        <p className="text-gray-600 mb-6">
          The new bike park <strong>{data.name}</strong> in <strong>{data.location}</strong> has been successfully created and added to the database.
        </p>
...
export default BikeParkCreatedDalog;
